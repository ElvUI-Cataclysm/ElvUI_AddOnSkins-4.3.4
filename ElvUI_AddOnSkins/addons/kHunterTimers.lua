...
function addon:KHunterTimers()
	...
	for i = 1, 11 do
		--_G["KHunterTimersStatus"..i.."Bar"]:SetStatusBarTexture(nil);
		--_G["KHunterTimersStatus"..i.."Bar"]:SetStatusBarTexture(E["media"].normTex);
		--_G["KHunterTimersStatus"..i.."Bar"]:CreateBackdrop()
		_G["KHunterTimersStatus"..i.."Icon"]:SetTexCoord(unpack(E.TexCoords));
	end
